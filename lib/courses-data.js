...
export const COURSES = [
  {
    ...
    price: 199, originalPrice: 449, discount: 55,
    ...
    description: 'The most comprehensive SAP Business Technology Platform course ever built. Master every BTP pillar — CAP, HANA Cloud, Kyma, Integration Suite, Fiori, Workflow, AI Core — with 8 enterprise-grade capstone projects.',
    whatYouLearn: [
    ...
    instructor: { name: 'Rajesh Kumar', title: 'Principal SAP Architect · SAP Mentor', avatar: 'https://i.pravatar.cc/150?img=12', rating: 4.9, students: 28400, courses: 8, bio: '18 years architecting SAP for Fortune 500. Ex-SAP Labs. Official SAP Mentor.' },
  ...
  },
  {
    ...
    level: 'Intermediate', language: 'English',
    duration: '42h', lectures: 108, students: 8940, rating: 4.8, reviews: 1620,
    price: 129, originalPrice: 289, discount: 56,
    ...
    description: 'Modern ABAP for the S/4HANA era. Master CDS Views, AMDP, RESTful ABAP Programming (RAP), OData services, and clean ABAP principles. Everything you need to build production S/4HANA apps.',
    whatYouLearn: [
    ...
    instructor: { name: 'Suresh Iyer', title: 'S/4HANA Solution Architect · SAP Press Author', avatar: 'https://i.pravatar.cc/150?img=13', rating: 4.9, students: 34200, courses: 6, bio: '22 years in SAP development. Author of 3 SAP Press books on ABAP.' },
    curriculum: mkCurriculum([
  ...
  },
  {
    ...
    level: 'Intermediate', language: 'English',
    duration: '36h', lectures: 92, students: 5240, rating: 4.8, reviews: 940,
    price: 119, originalPrice: 249, discount: 52,
    ...
    instructor: { name: 'Anjali Desai', title: 'SAP Fiori UX Lead · Deloitte', avatar: 'https://i.pravatar.cc/150?img=25', rating: 4.9, students: 22600, courses: 5, bio: 'Ex-SAP Design Lead. 15 years building enterprise UX for Fortune 100.' },
    curriculum: mkCurriculum([
  ...
  },
  {
    ...
    level: 'Intermediate', language: 'English',
    duration: '44h', lectures: 118, students: 7180, rating: 4.7, reviews: 1420,
    price: 139, originalPrice: 299, discount: 54,
    ...
    instructor: { name: 'Meera Nair', title: 'SF Solution Architect · 12x Certified', avatar: 'https://i.pravatar.cc/150?img=41', rating: 4.8, students: 18400, courses: 7, bio: 'Ex-SAP SuccessFactors consultant. Trained 8,000+ SF professionals.' },
    curriculum: mkCurriculum([
...
export const TESTIMONIALS = [
  { name: 'Arjun Patel', role: 'SAP Consultant → Integration Architect at Deloitte', avatar: 'https://i.pravatar.cc/150?img=68', text: 'The SAP CPI course transformed my career. Went from junior to architect in 14 months. The real-world scenarios and hands-on labs were game-changing.', rating: 5, course: 'SAP Integration Suite' },
  { name: 'Priya Nair', role: 'SAP BTP Developer at Accenture', avatar: 'https://i.pravatar.cc/150?img=48', text: 'IntegrationX Pro is THE place to learn SAP BTP. The CAP + Kyma modules gave me the confidence to lead our BTP migration project for a Fortune 500 client.', rating: 5, course: 'SAP BTP Mastery' },
  { name: 'Karthik Reddy', role: 'ABAP Developer → S/4HANA Consultant at TCS', avatar: 'https://i.pravatar.cc/150?img=53', text: 'The ABAP on HANA course covered RAP and CDS Views better than any book. I passed my S/4HANA certification on the first attempt.', rating: 5, course: 'SAP ABAP on HANA' },
  { name: 'Sarah Johnson', role: 'SF Consultant at Capgemini', avatar: 'https://i.pravatar.cc/150?img=49', text: 'Best SuccessFactors training I have ever taken. Meera explains configuration nuances that no other course teaches. Landed a senior SF role after this.', rating: 5, course: 'SuccessFactors HXM' },
  { name: 'Rahul Verma', role: 'Fiori Developer at Infosys', avatar: 'https://i.pravatar.cc/150?img=60', text: 'From basic UI5 to shipping enterprise Fiori Elements apps in 3 months. The custom control section is pure gold.', rating: 5, course: 'SAP Fiori / UI5' },
  { name: 'Ana Silva', role: 'ML Engineer at Google', avatar: 'https://i.pravatar.cc/150?img=32', text: 'The GenAI course is genuinely the best AI training on the internet. Practical, deep, and updated with the latest models.', rating: 5, course: 'GenAI & LLM Engineering' },
]
